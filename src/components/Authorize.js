        ...
        <div style={styles.body}>
            ...
            <div>
                <label style={styles.row}>
                    ...
                    <input style={styles.input} type={'text'} value={login} onChange={event => setLogin(event.target.value)}/>
                </label>
                <label style={styles.row}>
                ...
                <div style={styles.row}>
                    <button disabled={!(login && password)} onClick={authorize} style={styles.button}>Войти</button>
                </div>
                <div style={styles.row}>
                    <span style={styles.labelResetPassword} onClick={ () => props.history.replace('./restore')}>Восстановить пароль</span>
                </div>
            ...
            <div>
                ...
                <label style={styles.row}>
                    ...
                    <input style={styles.input} type={'password'} value={checkPassword}
                           onChange={event => setCheckPassword(event.target.value)}/>
                </label>
                <div style={styles.row}>
                    <button disabled={!(login && name && password && password === checkPassword)}
